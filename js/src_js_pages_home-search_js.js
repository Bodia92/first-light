"use strict";
(self["webpackChunkglivera_webpack_template"] = self["webpackChunkglivera_webpack_template"] || []).push([["src_js_pages_home-search_js"],{
...
/***/ "./src/js/components/hero-video.js":
/*!*****************************************!*\
  !*** ./src/js/components/hero-video.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
// import 'ScssPlugins/_plyr.scss';


var heroVideo = function heroVideo() {
  var sectionSelector = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '.js-hero-section';
  var video = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '.js-hero-video';
  var $sections = document.querySelector(sectionSelector);
  if (!(0,_utils__WEBPACK_IMPORTED_MODULE_0__.exist)($sections)) return;
  var $video = $sections.querySelector(video); // const player = new Plyr($video);
};
...
/* harmony import */ var components_banner_slider__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! components/banner-slider */ "./src/js/components/banner-slider.js");
/* harmony import */ var components_hero_video__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! components/hero-video */ "./src/js/components/hero-video.js");
...
var index = function index() {
  ...
  (0,components_hero_video__WEBPACK_IMPORTED_MODULE_3__["default"])();
  ...
  (0,components_banner_slider__WEBPACK_IMPORTED_MODULE_2__["default"])();
...
//# sourceMappingURL=src_js_pages_home-search_js.js.map