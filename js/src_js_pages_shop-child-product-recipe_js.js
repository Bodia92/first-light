"use strict";
(self["webpackChunkglivera_webpack_template"] = self["webpackChunkglivera_webpack_template"] || []).push([["src_js_pages_shop-child-product-recipe_js"],{
...
/***/ "./src/js/components/featured-recipe.js":
/*!**********************************************!*\
  !*** ./src/js/components/featured-recipe.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var ScssComponents_recipes_card_mixin_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ScssComponents/recipes-card-mixin.scss */ "./src/scss/components/recipes-card-mixin.scss");
/* harmony import */ var ScssComponents_featured_recipe_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ScssComponents/featured-recipe.scss */ "./src/scss/components/featured-recipe.scss");
/* harmony import */ var ScssComponents_product_pairs_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ScssComponents/product-pairs.scss */ "./src/scss/components/product-pairs.scss");
...
/* harmony import */ var _utils_constants__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../utils/constants */ "./src/js/utils/constants.js");
...
/* harmony import */ var swiper_css_effect_fade__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! swiper/css/effect-fade */ "./node_modules/swiper/modules/effect-fade/effect-fade.min.css");
...
var featuredRecipe = function featuredRecipe() {
  var sliderSelector = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '.js-featured-recipe-slider';
  var btnNextSelector = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '.js-featured-recipe-next-button';
  var btnPrevSelector = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '.js-featured-recipe-prev-button';
  swiper__WEBPACK_IMPORTED_MODULE_3__["default"].use([swiper__WEBPACK_IMPORTED_MODULE_3__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_3__.EffectFade]);
  var $slider = document.querySelector(sliderSelector);
  var $btnNext = document.querySelector(btnNextSelector);
  var $btnPrev = document.querySelector(btnPrevSelector);
  if (!(0,_utils__WEBPACK_IMPORTED_MODULE_4__.exist)([$slider, $btnNext, $btnPrev])) return;
  var featuredRecipeSwiper;

  var initSwiper = function initSwiper() {
    return new swiper__WEBPACK_IMPORTED_MODULE_3__["default"]($slider, {
      speed: 800,
      loop: true,
      effect: 'fade',
      fadeEffect: {
  ...
  (0,_utils__WEBPACK_IMPORTED_MODULE_4__.onWindowResize)(function () {
    if ((0,_utils__WEBPACK_IMPORTED_MODULE_4__.getWindowSize)().windowWidth < _utils_constants__WEBPACK_IMPORTED_MODULE_5__.BREAKPOINTS.mediaPoint1) {
      if (!featuredRecipeSwiper) {
        console.log('-');
        featuredRecipeSwiper = initSwiper();
      }
    } else {
      if (featuredRecipeSwiper) {
        console.log('+');
        featuredRecipeSwiper.destroy();
        featuredRecipeSwiper = null;
      }
    }
  });
};

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (featuredRecipe);
...
/* harmony import */ var components_featured_recipe__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! components/featured-recipe */ "./src/js/components/featured-recipe.js");
...
var ShopChildProductRecipe = function ShopChildProductRecipe() {
  ...
  (0,components_featured_recipe__WEBPACK_IMPORTED_MODULE_5__["default"])();
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ShopChildProductRecipe);
...
/***/ "./src/scss/components/featured-recipe.scss":
/*!**************************************************!*\
  !*** ./src/scss/components/featured-recipe.scss ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
//# sourceMappingURL=src_js_pages_shop-child-product-recipe_js.js.map